...
insert into videos (title, description, youtube_id, drama, views) values ("Pendulum", "A short three minute Japanese animation called 'Furiko' or 'Pendulum' originally made by Takefumi Kurashina with Muse's Exogenesis Symphony part III", "JXcV6dOMUZs", 1, 1372141);
...
insert into playlists (title, list) values ("Editors choice", "1 2 3 4 5");
