...
insert into videos (title, description, youtube_id, documentary, views) values ("Ethiopian tribes in the Omo Valley", "I spent a month in Ethiopia. I was lucky to be able to spend time with some of the amazing tribes in the south-west corner of Ethiopia. Here is my tale.....", "nL3SHtC5jGA", 1, 791642;
